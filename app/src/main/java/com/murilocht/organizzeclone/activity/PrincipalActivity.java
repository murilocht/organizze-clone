...
import com.murilocht.organizzeclone.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("OrganizzeClone");
    ...
    public void configuraCalendarView() {
        ...
        CalendarDay dataAtaual = calendarView.getCurrentDate();

        String mesSelecionado = String.format("%02d", (dataAtaual.getMonth() + 1));
        mesAnoSelecionado = mesSelecionado + "" + dataAtaual.getYear();
